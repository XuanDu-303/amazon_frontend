                ...
                <div className="col-6">
                    <div className="main-banner position-relative">
                        ...
                        <div className="main-banner-content position-absolute">
                            ...
                            <h5>iPad gen9</h5>
                            <p>From 1.999.000 ₫ to 4.999.000 ₫</p>
                    ...
                    <div className="d-flex flex-wrap gap-10 justify-content-between align-items-center">
                        <div className="small-banner position-relative">
                            ...
                            <div className="small-banner-content position-absolute">
                                <h4>BEST SALE</h4>
                                <h5>Laptops</h5>
                                <p>From 1.699.000 ₫<br /> to 2.299.000 ₫</p>
                            </div>
                        </div>
                        <div className="small-banner position-relative">
                        ...
                        <div className="small-banner position-relative">
                            ...
                            <div className="small-banner-content position-absolute">
                                <h4>NEW ARRIVAL</h4>
                                <h5>Buy IPad Air</h5>
                                <p>From 2.599.000 ₫<br /> to 4.999.000 ₫</p>
                            </div>
                        </div>
                        <div className="small-banner position-relative">
                ...
                <div className="col-3">
                    <div className="famous-card position-relative">
                        ...
                        <div className="famous-content position-absolute">
                            ...
                            <p className='text-dark'>Now in Green. From 999.000 ₫ to 1.410.000 ₫</p>
                        </div>
                    </div>
                </div>
                <div className="col-3">
                    <div className="famous-card position-relative">
                        ...
                        <div className="famous-content position-absolute">
                            ...
                            <p className='text-dark'>From 699.000 ₫ to 1.165.000 ₫</p>
                        </div>
                    </div>
                </div>
            </div>
