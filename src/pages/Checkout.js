...
const Checkout = () => {
    ...
    const checkOutHandler = async () => {
        ...
        const options = {
            ...
            prefill: {
                name: "Amazon",
                email: "xuandu2003@example.com",
                contact: "123457890",
            },
            notes: {
                address: "Amazon office",
            },
            theme: {
                color: "#61dafb",
            },
                ...
                <div className="row">
                    <div className="col-7">
                        <div className="checkout-left-data">
                            ...
                            <p className="user-details total">xuan du (xuandu2003@gmail.com)</p>
                    ...
                    <div className="col-5">
                                ...
                                cartState && cartState?.map((item, index) => {
                                    return (
                                        <div key={index} className="d-flex gap-10 mb-2 align-items-center">
                                            ...
                                            <div className='flex-grow-1'>
                                                <h5 className='total'>{formatCurrency(item?.price * item?.quantity)}</h5>
                                            </div>
                                        </div>
                                    )
                                })
                        ...
                        <div className='border-bottom py-4'>
                            <div className='d-flex justify-content-between align-items-center'>
                                ...
                                <p className='total-price'>{formatCurrency(totalAmount ? totalAmount : "0")}</p>
                            </div>
                            <div className='d-flex justify-content-between align-items-center'>
                                <p className='mb-0 total'>Shipping</p>
                                <p className='mb-0 total-price'>15.000 ₫</p>
                            </div>
                        </div>
                        <div className='d-flex justify-content-between align-items-center border-bottom py-4'>
                            <h4 className='total'>Total</h4>
                            <h5 className='total-price'>{formatCurrency(totalAmount ? totalAmount + 5 : "0")}</h5>
                        </div>
                    </div>
                </div>
            </Container>
