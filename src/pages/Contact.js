            ...
            <Container class1="contact-wrapper py-5 home-wrapper-2">
                <div className="row">
                    <div className="col-12">
                        <iframe title="Google Maps Location" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.6441591267126!2d108.21872757425389!3d16.032028884642084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314218389cf02c2b%3A0xbdc63233587e2d88!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyDEkMO0bmcgw4E!5e0!3m2!1svi!2s!4v1722800856923!5m2!1svi!2s" width="600" height="450" className='border-0 w-100' allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                                ...
                                <div>
                                    <ul className='ps-0'>
                                        <li className='mb-3 d-flex gap-15 align-items-center'>
                                            ...
                                            <address className='mb-0'>Xo Viet Nghe Tinh, Da Nang</address>
                                        </li>
                                        <li className='mb-3 d-flex gap-15 align-items-center'>
                                        ...
                                        <li className='mb-3 d-flex gap-15 align-items-center'>
                                            ...
                                            <a href="mailto: f-digitic@gmail.com">Amazon@gmail.com</a>
                                        </li>
                                        <li className='mb-3 d-flex gap-15 align-items-center'>
